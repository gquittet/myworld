...
beautiful.init("/home/gquittet/.config/awesome/themes/my-theme/theme.lua")
...
globalkeys = gears.table.join(
    -- Lock the screen
    awful.key({ "Mod1", "Control" }, "l", function ()  awful.util.spawn("sync") awful.util.spawn("xautolock -locknow") end),
